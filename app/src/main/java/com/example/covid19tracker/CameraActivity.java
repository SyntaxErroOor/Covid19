...
//        }
    ...
    protected void setFragment() {
        ...
        Fragment fragment;
        if (useCamera2API) {
            com.example.covid19tracker.CameraConnectionFragment camera2Fragment =
                    com.example.covid19tracker.CameraConnectionFragment.newInstance(
                            new com.example.covid19tracker.CameraConnectionFragment.ConnectionCallback() {
                                @Override
            ...
            com.example.covid19tracker.LegacyCameraConnectionFragment frag = new com.example.covid19tracker.LegacyCameraConnectionFragment(this,
                    getLayoutId(),
