                ...
                switch (conuter) {
                    ...
                    case 1:
                        ...
                        if (number_check_answer != 0) {
                            ...
                            Toast.makeText(questions.this, "Please Select!", Toast.LENGTH_SHORT).show();
                        }
                        break;
                    case 2:
                        number_check_answer = 0;
                    ...
                    case 3:
                        ...
                        if (number_check_answer != 0) {
                            ...
                            if (Score < 8) {
                                ...
                                Intent i = new Intent(questions.this, ResultNegativeActivity.class);
                                ...
                                Intent i = new Intent(questions.this, ResultPositiveActivity.class);
                                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(i);
